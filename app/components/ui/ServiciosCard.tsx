  ...
  return (
    ...
    <div className="bg-black w-full flex justify-center">
      <div className="flex items-center flex-col pb-16 pt-11 px-8 lg:px-[7rem] lg:grid lg:justify-center lg:grid-cols-2 lg:max-w-[1300px] lg:w-full">
        <div className="w-full flex gap-3 items-center mb-8 justify-center lg:gap-5 lg:justify-start lg:self-end">
          <div className="service-icon">{icon}</div>
          <h3>{title}</h3>
        </div>
        <div className="w-[368px] mb-12 lg:row-span-2 lg:mb-0 lg:w-[42vw] lg:max-w-[550px] justify-self-end">
    ...
    <div className="flex items-center flex-col pb-16 pt-11 px-8 lg:px-[7rem] lg:grid lg:justify-center lg:grid-cols-2 lg:max-w-[1300px] lg:w-full">
      <div className="w-full flex gap-3 items-center mb-8 justify-center lg:gap-5 lg:justify-start lg:self-end lg:w-[378px] lg:justify-self-end">
      <div className="service-icon">{icon}</div>
        <h3>{title}</h3>
      </div>
      <div className="w-[368px] mb-12 lg:mb-0 lg:row-start-1 lg:row-end-3 lg:w-[42vw] lg:max-w-[550px] justify-self-end">
