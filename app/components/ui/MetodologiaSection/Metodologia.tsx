...
const metodologiaData = [
	{
	  icon: <PaperSVG />,
	  scrollNumber: { desktop: 3475, mobile: 4376 },
	...
	{
	  icon: <MonitorSVG />,
	  scrollNumber: { desktop: 3770, mobile: 4906 },
	  title: "Diseño",
	...
	{
	  icon: <PaperArrowsSVG />,
	  scrollNumber: { desktop: 4080, mobile: 5387 },
	  title: "Revisiones",
	...
	{
	  icon: <CodeMonitorSVG />,
	  scrollNumber: { desktop: 4390, mobile: 5929 },
	...
	},
	{
	  ...
	  scrollNumber: { desktop: 4697, mobile: 6410 },
	...
	},
	{
	  ...
	  scrollNumber: { desktop: 4995, mobile: 6890 },
