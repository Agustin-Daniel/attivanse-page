    ...
    <section id="servicios" className="flex flex-col bg-black lg:items-center">
        ...
        <div className="bg-black w-full flex justify-center">
          <div className="flex items-center flex-col pb-16 pt-11 px-8 lg:px-[7rem] lg:grid lg:justify-center lg:grid-cols-2 lg:max-w-[1300px] lg:w-full">
              ...
              <Image  className="w-[301px] mb-12 lg:row-span-2 lg:mb-0 lg:w-[42vw] lg:max-w-[495px] justify-self-end" src="/img/service-design.png" width={495} height={487} alt="design image" />
        ...
        <div className="bg-lightblack w-full flex justify-center">
          <div className="flex items-center flex-col pb-16 pt-11 px-8 lg:px-[7rem] bg-lightblack lg:grid lg:justify-center lg:grid-cols-2 lg:max-w-[1300px] lg:w-full">
              ...
              <Image  className="w-[368px] mb-12 lg:mb-0 lg:row-start-1 lg:row-end-3 lg:w-[42vw] lg:max-w-[550px] justify-self-end" src="/img/service-technology.png" width={611} height={487} alt="technology image" />
        ...
        <div className="bg-black w-full flex justify-center">
          <div className="flex items-center flex-col pb-16 pt-11 px-8 lg:px-[7rem] lg:grid lg:justify-center lg:grid-cols-2 lg:max-w-[1300px] lg:w-full">
              ...
              <Image  className="w-[297px] mb-12 lg:row-span-2 lg:mb-0 lg:w-[42vw] lg:max-w-[487px] justify-self-end" src="/img/service-addons.png" width={504} height={519} alt="addons image" />
              <div className="w-full max-w-[301px] flex flex-col lg:self-start lg:max-w-[378px]">
                <p className="mb-10">Lörem ipsum ser. Pokenad kvasir berat. Pseudov mobevis ponde monedossade i vusamma. Mipektig sisat fån beda, pres. Dologi bigen, plalig, besk.</p>
                <ul className="flex flex-col gap-4 w-fit">
        ...
        <div className="bg-lightblack w-full flex justify-center">
          <div className="flex items-center flex-col pb-16 pt-11 px-8 lg:px-[7rem] bg-lightblack lg:grid lg:justify-center lg:grid-cols-2 lg:max-w-[1300px] lg:w-full">
              ...
              <Image  className="w-[355px] mb-12 lg:mb-0 lg:row-start-1 lg:row-end-3 lg:w-[42vw] lg:max-w-[550px] justify-self-end" src="/img/service-marketing.png" width={561} height={489} alt="marketing image" />
              <div className="w-full max-w-[301px] flex flex-col lg:self-start lg:justify-self-end lg:max-w-[378px]">
                <p className="mb-10">Lörem ipsum ser. Pokenad kvasir berat. Pseudov mobevis ponde monedossade i vusamma. Mipektig sisat fån beda, pres. Dologi bigen, plalig, besk.</p>
                <ul className="flex flex-col gap-4 w-fit">
