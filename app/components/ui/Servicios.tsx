...
export const Servicios = () => {
  return (
    <section className="flex flex-col bg-gray">
        ...
        <div className="flex items-center flex-col px-8 pb-16 pt-11">
            <div className="flex gap-1 items-center mb-8"><div className="service-icon"><PenSVG /></div><h3>Diseño</h3></div>
            <Image className="w-[301px] mb-12" src="/img/design.png" width={495} height={487} alt="design image" />
