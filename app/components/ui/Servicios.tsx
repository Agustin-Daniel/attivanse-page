    ...
    <section id="servicios" className="flex flex-col bg-black lg:items-center">
        ...
        <div className="bg-black w-full flex justify-center">
          <div className="flex items-center flex-col pb-16 pt-11 px-8 lg:px-[7rem] lg:grid lg:justify-center lg:grid-cols-2 lg:max-w-[1300px] lg:w-full">
              <div className="w-[301px] flex gap-3 items-center mb-8 justify-center lg:gap-5 lg:justify-start lg:self-end"><div className="service-icon"><PenSVG /></div><h3>Diseño</h3></div>
              ...
              <div className="w-[301px] flex flex-col lg:self-start lg:w-[378px]">
        ...
        <div className="bg-gray w-full flex justify-center">
          <div className="flex items-center flex-col pb-16 pt-11 px-8 lg:px-[7rem] bg-gray lg:grid lg:justify-center lg:grid-cols-2 lg:max-w-[1300px] lg:w-full">
              <div className="w-[301px] flex gap-3 items-center mb-8 justify-center lg:gap-5 lg:justify-start lg:self-end lg:w-[378px] lg:justify-self-end"><div className="service-icon"><CodeSVG /></div><h3>Tecnologia</h3></div>
              ...
              <div className="w-[301px] flex flex-col lg:self-start lg:justify-self-end lg:w-[378px]">
                <p className="mb-10">Lörem ipsum ser. Pokenad kvasir berat. Pseudov mobevis ponde monedossade i vusamma. Mipektig sisat fån beda, pres. Dologi bigen, plalig, besk.</p>
                <ul className="flex flex-col gap-4 w-fit">
        ...
        <div className="bg-black w-full flex justify-center">
          <div className="flex items-center flex-col pb-16 pt-11 px-8 lg:px-[7rem] lg:grid lg:justify-center lg:grid-cols-2 lg:max-w-[1300px] lg:w-full">
              <div className="w-[301px] flex gap-3 items-center mb-8 justify-center lg:gap-5 lg:justify-start lg:self-end"><div className="service-icon"><AddonsSVG /></div><h3>Agregados</h3></div>
        ...
        <div className="bg-gray w-full flex justify-center">
          <div className="flex items-center flex-col pb-16 pt-11 px-8 lg:px-[7rem] bg-gray lg:grid lg:justify-center lg:grid-cols-2 lg:max-w-[1300px] lg:w-full">
              <div className="w-[378px] flex gap-3 items-center mb-8 justify-center lg:gap-5 lg:justify-start lg:self-end lg:justify-self-end"><div className="service-icon"><MegaphoneSVG /></div><h3>Marketing</h3></div>
