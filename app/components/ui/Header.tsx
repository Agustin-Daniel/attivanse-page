...
export const Header = () => {
	...
	return (
		<header className="bg-header-img-480 bg-top bg-no-repeat px-6 flex pt-36 w-full h-[502px] sm:bg-header-img-768 md:bg-left lg:bg-top md:bg-header-img-1920 md:px-12 lg:h-[106vh] lg:max-h-[1178px] lg:pl-28 lg:pt-0 lg:items-center">
